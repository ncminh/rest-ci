 ...
 * A fully REST-ful server implementation for CodeIgniter using one library, one config file and one controller.
 *
 * This should be refactored later on.
 *
 * @package         CodeIgniter
...
abstract class REST_Controller extends \CI_Controller {
    ...
    /**
     * The request has succeeded (Request thành công)
     */
    const HTTP_OK = 200;

    /**
     * The server successfully created a new resource (Server đã tạo 1 resource mới thành công)
     */
     ...
     *  Server đã xử lý request thành công và không có nội dung trả về
     */
     ...
     * Resource không bị chỉnh sửa kể từ lần request cuối
     */
    ...
    // Client Error : Lỗi phía client

    /**
     * The request cannot be fulfilled due to multiple errors
     *  Request không thể được đáp ứng vì nhiều lỗi phát sinh
     */
     ...
     *  Resource không sẵn có ở thời điểm request
     */
    const HTTP_FORBIDDEN = 403;

    /**
     * The requested resource could not be found (Không tìm thấy resource)
     *
     * Note: This is sometimes used to mask if there was an UNAUTHORIZED (401) or
     * FORBIDDEN (403) error, for security reasons
     * Ghi chú: Code này đôi khi được dùng để thay thế cho 401 và 403 nhằm tăng tính bảo mật
     */
    const HTTP_NOT_FOUND = 404;

    /**
     * The request method is not supported by the following resource
     *  Phương thức request không được hỗ trợ bởi resource
     */
    const HTTP_METHOD_NOT_ALLOWED = 405;

    /**
     * The request was not acceptable
     *  Request không được chấp nhận
     */
     ...
     * of the resource
     * Không thể hoàn tất request vì xung đột trạng thái với resource
     */
    ...
    // Server Error : Lỗi phía server

    /**
     * The server encountered an unexpected error
     * Lỗi không mong muốn ở server. (Đây là lỗi chung nhất cho phía server)
     ...
     * Máy chủ không nhận biết đươc phương thức request
     */
    ...
    /**
     * Định dạng rest, phải được override trong controller
     *
     * @var string|NULL
     */
     ...
     * Định nghĩa danh sách các thuộc tính của phương thức như limit, log và level
     *
     * @var array
     */
    protected $methods = [];
     ...
     * Danh sách các phương thức HTTP được cho phép
     *
     * @var array
     */
    ...
    /**
     * Contains details about the request (Lưu trữ chi tiết request)
     * Fields: body, format, method, ssl
     * Note: This is a dynamic object (stdClass) . Đây là một đối tượng động (stdClass)
     *
     * @var object
     */
    ...
    /**
     * Contains details about the response (Lưu trữ chi tiết response)
     * Fields: format, lang
     * Note: This is a dynamic object (stdClass) . Đây là một đối tượng động (stdClass)
     *
     * @var object
